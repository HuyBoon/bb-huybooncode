...
const projects = [
	{
		...
		description:
			"A website for a luxury spa, featuring service listings, booking functionality, and a relaxing user interface designed to attract clients.",
	...
	{
		title: "Amazing Phú Quốc - Tour and Travel",
		description:
			"A travel agency website offering tour packages, destination guides, and booking services for Phú Quốc travelers.",
	...
	},
	{
		title: "MK-Nails & Spa",
		description:
			"A modern website for a nail and spa salon, showcasing services, customer reviews, and online booking capabilities.",
	...
	},
	{
		title: "Varia Hotel",
		description:
			"A hotel booking website with room showcases, availability checking, and integrated payment systems for a seamless user experience.",
